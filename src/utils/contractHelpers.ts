...
import miniDogeAbi from 'config/abi/minidoge.json'
...
export const getMiniDOGEContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(miniDogeAbi, getMiniDOGEAddress(), signer)
}
